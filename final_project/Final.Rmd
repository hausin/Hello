...
MyData16 <- read.csv(file="/Users/loy07/Desktop/R_final_proj/cleanData2016.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
MyData15 <- read.csv(file="/Users/loy07/Desktop/R_final_proj/cleanData2015.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
MyData14 <- read.csv(file="/Users/loy07/Desktop/R_final_proj/cleanData2014.csv", header=TRUE, sep=",", stringsAsFactors = FALSE)
...
for (i in 1:nrow(MyData16))
  ...
  if(MyData16$Accident_Severity[i]=="fatal"){
    ylb[1]=ylb[1]+1
  } else if(MyData16$Accident_Severity[i]=="serious"){
    ylb[2]=ylb[2]+1
  } else{
    ylb[3]=ylb[3]+1
  }
#fatal=1695,serious=21725,slight=113201 (2016)
...
if(MyData15$Accident_Severity[i]=="fatal"){
  ylb[1]=ylb[1]+1
} else if(MyData15$Accident_Severity[i]=="serious"){
  ylb[2]=ylb[2]+1
} else{
  ylb[3]=ylb[3]+1
}
...
if(MyData14$Accident_Severity[i]=="fatal"){
  ylb[1]=ylb[1]+1
} else if(MyData14$Accident_Severity[i]=="serious"){
  ylb[2]=ylb[2]+1
} else{
  ylb[3]=ylb[3]+1
}
...
ggplot(MyData16, aes(x = Accident_Severity, fill = Accident_Severity)) +
